...
adjacent_values_difference_check_max_to_many_dimensions_dict = {
    'dimensions': {
    },
    'variables': {
        'test_pass': {
...
def test_adjacent_values_difference_check_maximum_difference_not_specified():
    """
    Test adjacent_values_difference_check when variable doesn't
    have as many dimensions as specified.
    """
    ...
    qc_obj.add_qc_checks_dict(adjacent_values_difference_check_max_to_many_dimensions_dict)
